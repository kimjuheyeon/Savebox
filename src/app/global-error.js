      ...
      <body>
        <main className="mx-auto w-full max-w-[440px] px-4 py-12">
          <div className="rounded-[8px] border border-rose-200 bg-rose-50 p-4">
            <p className="text-sm font-semibold text-rose-700">서비스 오류가 발생했습니다</p>
            <h1 className="mt-2 text-xl font-black text-slate-900">요청을 처리하지 못했습니다</h1>
            <p className="mt-2 text-sm text-slate-600">브라우저를 새로고침해 보시거나 홈으로 이동해 주세요.</p>
